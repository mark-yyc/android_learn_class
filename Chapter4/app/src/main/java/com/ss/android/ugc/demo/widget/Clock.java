...
import com.ss.android.ugc.demo.ClockHandlerThread;
...
public class Clock extends View {
    ...
    ClockHandlerThread clockHandlerThread;
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        clockHandlerThread=new ClockHandlerThread("clock");

        clockHandlerThread.setOnTimeChangeLister(new ClockHandlerThread.OnTimeChangeListener() {
            @Override
            public void afterChanged() {
                Log.d(TAG, "run: postInvalidate invoked.");
                postInvalidate();
            }
        });
